...
export const Caseking: Store = {
  ...
  labels: {
    inStock: [
      {
        container: '.product-availability-message',
        text: ['auf lager', 'vorbestellung'],
      },
      {
    ...
    outOfStock: [
      ...
      {
        container: '#maincontent > div > div.row.justify-content-center.mb-9 > div > div > div > div > div.col-md-8 > h3',
        text: ['leider haben wir dazu nichts gefunden.'],
      }
    ],
  },
  links: [
    {
      ...
      model: 'test:model',
      series: 'test:series',
      url: 'https://www.caseking.de/gigabyte-radeon-rx-7700-xt-gaming-oc-12228-mb-gddr6/GCGB-505.html',
    },
    {
      brand: 'asus',
      model: 'strix oc',
    ...
    },
    {
      ...
      series: '5080',
      url: 'https://www.caseking.de/msi-geforce-rtx-5080-16g-suprim-liquid-soc-16384-mb-gddr7/GCMC-338.html',
    },
    // {
    //   brand: 'msi',
    ...
    // },
    {
      ...
      model: 'ventus 3x oc',
      series: '5080',
      url: 'https://www.caseking.de/msi-geforce-rtx-5080-16g-ventus-3x-oc-16384-mb-gddr7/GCMC-404.html',
    },
    {
      brand: 'msi',
